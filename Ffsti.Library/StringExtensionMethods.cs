    ...
    public static class StringExtensionMethods
    {
        ...
        public static string FormatarCpf(this string text)
        {
            ...
            else
            {
                ...
                return string.Format("{0}.{1}.{2}-{3}",
                    int.Parse(text.Substring(0, 3)), text.Substring(3, 3), text.Substring(6, 3), text.Substring(9, 2));
            }
        }
        ...
        public static string FormatarTelefone(this string text)
        {
            ...
            else
            {
                ...
                else return string.Format("({0}) {1}-{2}", text.Substring(0, 2), text.Substring(2, 4), text.Substring(6, 4));
            }
        }
